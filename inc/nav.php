<nav class="side-bar">
            ...
            ?>
                ...
                <ul id="navlist">
                    ...
                    <li><a href="my_task.php"><i class="fa fa-tasks" aria-hidden="true"></i> <span>My Tasks</span></a></li>
...
<ul id="navlist">
    ...
    <li>
        <a href="create_task.php">
            <i class="fa fa-plus" aria-hidden="true"></i> <span>Create Task</span>
        </a>
    </li>
    <li>
        <a href="tasks.php">
            <i class="fa fa-tasks" aria-hidden="true"></i> <span>All Tasks</span>
        </a>
    </li>
    <li>
